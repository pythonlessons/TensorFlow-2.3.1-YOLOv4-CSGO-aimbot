...
data_dir = '/CSGO_images/'
Dataset_names_path = "model_data/CSGO_images.txt"
Dataset_train = "model_data/CSGO_images_train.txt"
Dataset_test = "model_data/CSGO_images_test.txt"
is_subfolder = False
